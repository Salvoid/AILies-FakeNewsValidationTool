...
def main():
    ...
    sys.stdout =  open(otherModule.define_relativepath(True,".\\output\\facebook_news_politics\\facebook_news_politics_console.txt"), 'w')
    ...
    df_dataset_wordset_train_raw.to_csv(".\\output\\facebook_news_politics\\facebook_news_politics_dataset_train_raw.csv")
    df_dataset_wordset_test_raw.to_csv(".\\output\\facebook_news_politics\\facebook_news_politics_dataset_test_raw.csv")
    ...
    cv_countVect_facebook, tf_tfidfTransformer_facebook, X_dataset_train_tfidf, y_dataset_train_values = processModule.process_dataset_train(df_dataset_wordset_train)

    # Training Model
    model_naivebayes_multinomial_facebook = processModule.train_model(X_dataset_train_tfidf, y_dataset_train_values)
    ...
    X_dataset_test_tfidf, y_dataset_test_values = processModule.process_dataset_test(cv_countVect_facebook, tf_tfidfTransformer_facebook, df_dataset_wordset_test)

    # Predicting Using Model
    y_dataset_prediction = processModule.predict_model(model_naivebayes_multinomial_facebook, X_dataset_test_tfidf)

    # Compute Accuracy
    processModule.compute_accuracy(y_dataset_test_values, y_dataset_prediction, ".\\output\\facebook_news_politics\\facebook_news_politics_cm.png")
    ...
    df_dataset_wordset_train_clean.to_csv(".\\output\\facebook_news_politics\\facebook_news_politics_dataset_train_clean.csv")
    df_dataset_wordset_test_clean_final.to_csv(".\\output\\facebook_news_politics\\facebook_news_politics_dataset_test_clean.csv")
